...
public List<Items> getPersonalCareData(){
    ...
    public List<Items> getClothingData (){
        String[] data={"Stockinas", "Underwear", "Paramas","T_Shirts", "Casual Dress", "Evening Dress",
    ...
    public List<Items> getBabyNeedsData(){
        String[] data={"Snapsuit", "Outfit", "Jumpsuit","Baby Socks", "Baby Hat", "Baby Pyjamas",
                ...
                "Baby Care Cover","Baby Shampoo",
                "Body Moisturizer",
                "Potty", "diaper Rash Cream", "Serum Physiological",
                "Nasal Asoirator","Fly Repellent Lotion","Pyrometer", "Antipyretic Syrup", "Probiotic Power"
                ,"Baby Backpack", "Stroller", "Baby Carrier","Toys"
                , "Teether", "Playpen", "Playpen", "Baby Radio",
    ...
    public List<Items> getHealthData () {
        String[] data={"Aspirin", "Drugs Used", "Vitamins Used", "Lens Solutions", "Condom","Hot Water Bag",
                "Tincture Of Lodine", "Adhesive Plaster",
    ...
    public List<Items> getBeachSuppliesData () {
        String[] data={"Sea Glasses", "Sea Bed", "Suntan Cream", "Beach Umbrella", "Swim Fins",
                "Beach Bag", "Beach Towel", "Beach Slippers", "Sunbed",
                "Snorkel", "Waterproof Clock",
        };
    ...
    public List<Items> getCarSuppliesData(){
        String[] data={"Pump", "Car Jack"
                , "Spare Car Key", "Accident Record Set", "Auto Refrigerator"
    ...
    public List<Items> getNeedsData (){
        String[] data={"Backpack",
                "Daily Bags", "Laundry Bag", "Sewing Kit",
