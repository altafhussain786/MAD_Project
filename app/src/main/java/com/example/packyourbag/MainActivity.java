...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if(mBackedPressed+TIME_INTERVAL >System.currentTimeMillis()) {
            super.onBackPressed();
            return;
        }
        else {
            Toast.makeText(this, "tap back btn to exit", Toast.LENGTH_SHORT).show();
        }
        mBackedPressed=System.currentTimeMillis();
    }


    //shared Preferences ccode yaha ha
